...
| [modern-toolchain-recipes.md](modern-toolchain-recipes.md) | JUnit/SARIF recipes for current test runners and static analyzers. |
...
| [task-success-eval.md](task-success-eval.md) | Known-path recoverability evaluation. |
